    ...
    return (
        <>
            <nav className={scrolled ? 'scrolled' : ''} role="navigation" aria-label="Main navigation">
                ...
                <div className="nav-r">
                    {/* Removed dark mode toggle to enforce a single consistent theme */}



                    <a href={`https://wa.me/${waNum}${waText}`} className="nav-wa" target="_blank" rel="noopener noreferrer" aria-label="Contact us on WhatsApp">
            ...
            >
                <div className="mobile-menu-inner">
                    ...
                    <a href={`https://wa.me/${waNum}${waText}`} className="btn-main mobile-cta" onClick={closeMenu}
