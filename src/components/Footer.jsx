                ...
                <div className="sw footer-grid">
                    ...
                    <div className="footer-col footer-brand-col">
                        ...
                        <div className="footer-socials">
                            <a href="https://instagram.com/ebravestudies" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-link">
                            ...
                            <a href="https://facebook.com/ebravestudies" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-link">
                            ...
                            <a href="https://wa.me/916282819122?text=Hello%2C%20I%20want%20to%20get%20more%20information%20about%20this" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-link social-wa">
                            ...
                            <a href="https://youtube.com/@ebravestudies" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="social-link">
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-contact">
                            <li>
                                ...
                                <a href="tel:+916282819122" style={{ color: 'inherit', textDecoration: 'none' }}>+91 6282 819 122</a>
                            </li>
                            <li>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                                <a href="mailto:ebravestudies@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }}>ebravestudies@gmail.com</a>
                            </li>
                            <li>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                                <a href="https://maps.google.com/?q=Malappuram, Kondotty, Kerala" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>Malappuram, Kondotty, Kerala</a>
                            </li>
                        </ul>
