                ...
                <div className="sw footer-grid">
                    ...
                    <div className="footer-col footer-brand-col">
                        ...
                        <div className="footer-socials">
                            ...
                            <a href={`https://wa.me/${import.meta.env.VITE_WA_NUMBER || '919544547861'}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-link social-wa">
