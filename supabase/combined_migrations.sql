-- ============================================================
-- E-Brave Operational System (EOS) - Combined Database Schema & RLS Hardening (Idempotent Version)
...
create index if not exists idx_students_lead on public.students(lead_id);
...
create index if not exists idx_reg_webinar on public.webinar_registrations(webinar_id);
...
-- ────────────────────────────────────────────────────────
-- HARDENED RLS POLICIES (Idempotent drops included)
-- ────────────────────────────────────────────────────────

-- 1. Profiles Table Policies
drop policy if exists "Allow authenticated read to profiles" on public.profiles;
...
drop policy if exists "Allow select sessions" on public.counseling_sessions;
...
drop policy if exists "Allow write sessions" on public.counseling_sessions;
...
drop policy if exists "Allow select webinars" on public.webinars;
...
drop policy if exists "Allow write webinars" on public.webinars;
...
drop policy if exists "Allow select webinar registrations" on public.webinar_registrations;
...
drop policy if exists "Allow write webinar registrations" on public.webinar_registrations;
...
drop policy if exists "Allow select content" on public.content;
...
drop policy if exists "Allow write tasks" on public.tasks;
...
drop policy if exists "Allow write campaigns" on public.campaigns;
...
drop policy if exists "Allow select activity logs" on public.activity_logs;
...
drop policy if exists "Allow management of rules" on public.automation_rules;
